...
- [ ] **Story Commit Created:** A commit exists that contains all changes for the current story before it is marked complete
- [ ] **Commit Standards:** Commit subject ≤72 chars, no agent co-author references, story key referenced
