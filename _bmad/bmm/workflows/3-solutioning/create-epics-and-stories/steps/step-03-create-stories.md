...
**Final Step:** Commit all code and documentation changes for this story before marking it complete.
...
4. **Final Step**: Include the required final completion step to commit all changes for the current story
