        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50"
            ...
            <div className="bg-app-main border border-app-subtle rounded-md p-6 w-96 space-y-4"
                ...
                <div className="space-y-3">
                    <div>
                        <label htmlFor="map-name" className="text-app-secondary mb-1 block text-xs font-medium">Name</label>
                    ...
                    <div>
                        <label htmlFor="map-url-pattern" className="text-app-secondary mb-1 block text-xs font-medium">URL Pattern</label>
                    ...
                    <div>
                        <label htmlFor="map-folder" className="text-app-secondary mb-1 block text-xs font-medium">Folder</label>
                ...
                <div className="flex justify-end gap-2 pt-2">
                    <button type="button" onClick={onClose}
                        className="border-app-subtle text-app-secondary h-9 rounded-md border px-4 text-sm">Cancel</button>
